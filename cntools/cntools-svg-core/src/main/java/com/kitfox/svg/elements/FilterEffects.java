...
import com.kitfox.svg.xml.attributes.FloatDefaultConstant;
...
public class FilterEffects extends SVGElement
{
	...
	private CSSQuantityAttribute y = new CSSQuantityAttribute( "y" );//0f;

	private CSSQuantityAttribute width = new CSSQuantityAttribute( "width" );//1f;

	private CSSQuantityAttribute height = new CSSQuantityAttribute( "height" );//1f;
	...
	{
		CSSQuantityDefaultConstant oneDefault = new CSSQuantityDefaultConstant( 1f );
		width.setDefault( oneDefault );
		height.setDefault( oneDefault );
