...
public class ClipPath extends SVGElement
{
	...
	IntAttribute clipPathUnits = new IntAttribute( "clipPathUnits" )
	{

		@Override
		public void setStringValue( String value )
		{
			setValue( value.equals( "objectBoundingBox" ) ? CP_OBJECT_BOUNDING_BOX
	...
	public ClipPath()
	{
		clipPathUnits.setDefaultSource( new IntDefaultConstant( CP_USER_SPACE_ON_USE ) );
	...
	{
		return clipPathUnits.getIntValue();
	}
