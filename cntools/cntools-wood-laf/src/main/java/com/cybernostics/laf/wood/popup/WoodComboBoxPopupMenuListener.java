...
public class WoodComboBoxPopupMenuListener implements PopupMenuListener
{
	// ==============================================================================
	// Members
	// ==============================================================================
	...
	// Constructors
	// ==============================================================================
	public WoodComboBoxPopupMenuListener()
	{
		super();
	}
	...
	public void popupMenuWillBecomeVisible( PopupMenuEvent e )
	{
		...
		if (popupMenu.getComponent( 0 ) instanceof JScrollPane)
		{
			...
			if (popupMenu instanceof ComboPopup)
			{
				...
				size.width = Math.max(
					box.getPreferredSize().width + bgLeft + bgRight,
					box.getWidth() );
				size.height = Math.min(
					scrollPane.getPreferredSize().height + bgTop + bgBottom,
					size.height + bgTop + bgBottom );
