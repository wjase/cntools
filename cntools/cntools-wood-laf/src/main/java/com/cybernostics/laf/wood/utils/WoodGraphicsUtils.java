...
package com.cybernostics.laf.wood.utils;
...
/**
 * The GraphicsUtils class for Wood Look And Feel
 * 
 * @author EASYNTH
 */
public class WoodGraphicsUtils extends SynthGraphicsUtils
{
	/**
	 ...
	 */
	public void drawLine( final SynthContext context,
		final Object paintKey,
		final Graphics g,
			final int x1,
		final int y1,
		final int x2,
		final int y2 )
	{
		...
		final int arcWidth = uiDefaults.getInt( "Wood.graphicsutils.drawline.arc.width" );
		final int arcHeight = uiDefaults.getInt( "Wood.graphicsutils.drawline.arc.height" );
		final Color lineColor = uiDefaults.getColor( "Wood.graphicsutils.drawline.color" );
		if (lineColor != null)
		{
		...
		if ("Tree.verticalLine".equals( paintKey ))
		{
			...
			if ("Tree.horizontalLine".equals( paintKey ))
			{
	 ...
	 * @param paintCenter
	 */
	public static void drawImageWith9Grids( Graphics g,
		Image img,
		int dx1,
		int dy1,
		int dx2,
