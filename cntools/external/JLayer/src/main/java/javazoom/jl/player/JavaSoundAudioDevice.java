/*
 * 11/26/04 Buffer size modified to support JRE 1.5 optimizations. (CPU usage < 1% under P4/2Ghz,
 * RAM < 12MB). jlayer@javazoom.net 11/19/04 1.0 moved to LGPL. 06/04/01 Too fast playback fixed.
 * mdm@techie.com 29/01/00 Initial version. mdm@techie.com
...
public class JavaSoundAudioDevice extends AudioDeviceBase
{
	...
	{
		return (int) ( time
			* ( fmt.getSampleRate() * fmt.getChannels() * fmt.getSampleSizeInBits() ) / 8000.0 );
	}
