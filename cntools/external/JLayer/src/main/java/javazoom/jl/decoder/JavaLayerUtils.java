/*
 * 11/19/04 1.0 moved to LGPL. 12/12/99 Initial version. mdm@techie.com
...
public class JavaLayerUtils
{
	 ...
	 */
	static public Object deserializeArray( InputStream in,
		Class elemType,
		int length )
		throws IOException
	{
	...
	static public Object deserializeArrayResource( String name,
		Class elemType,
		int length )
		throws IOException
	{
