 ...
 * 
 * 12/12/99 Based on Ibitstream. Exceptions thrown on errors, Temporary removed seek functionality.
 * mdm@techie.com
 * 
 * 02/12/99 : Java Conversion by E.B , javalayer@javazoom.net
 * 
 * 04/14/97 : Added function prototypes for new syncing and seeking mechanisms. Also made this file
 * portable. Changes made by Jeff Tsay
 * 
...
public final class Bitstream implements BitstreamErrors
{
	...
	private int readID3v2Header( InputStream in ) throws IOException
	{
		...
		in.read(
			...
			3 );
		// Look for ID3v2
		if (( id3header[ 0 ] == 'I' ) && ( id3header[ 1 ] == 'D' )
			&& ( id3header[ 2 ] == '3' ))
		{
			in.read(
				id3header,
			...
			in.read(
				...
				0,
				4 );
			size = (int) ( id3header[ 0 ] << 21 ) + ( id3header[ 1 ] << 14 )
