 ...
 * 
 * 14/02/99 MPEG_Args Based Class - E.B Adapted from javalayer and MPEG_Args. Doc'ed and integerated
 * with JL converter. Removed Win32 specifics from original Maplay code.
			...
			while (i < argc)
			{
				...
				if (argv[ i ].charAt( 0 ) == '-')
				{
					if (argv[ i ].startsWith( "-v" ))
					{
						...
						System.out.println( "Verbose Activated (level "
							+ verbose_level + ")" );
					}
