/*
 * 11/19/04 1.0 moved to LGPL. 12/12/99 Added appendSamples() method for efficiency. MDM. 15/02/99
 * ,Java Conversion by E.B ,ebsp@iname.com, JavaLayer
 * 
 * Declarations for output buffer, includes operating system implementation of the virtual Obuffer.
 * Optional routines enabling seeks and stops added by Jeff Tsay.
 * 
 ...
 * 
 * Idea and first implementation for u-law output with fast downsampling by Jim Boucher
