/*
 * 11/19/04 1.0 moved to LGPL. 16/11/99 Renamed class, added javadoc, and changed table name from
 * String to 3 chars. mdm@techie.com 02/15/99 Java Conversion by E.B, javalayer@javazoom.net
 * 
 * 04/19/97 : Adapted from the ISO MPEG Audio Subgroup Software Simulation Group's public c source
 * for its MPEG audio decoder. Miscellaneous changes by Jeff Tsay (ctsay@pasteur.eecs.berkeley.edu).
 * ----------------------------------------------------------------------- Copyright (c) 1991
 * MPEG/audio software simulation group, All Rights Reserved MPEG/audio coding/decoding software,
 * work in progress NOT for public distribution until verified and approved by the MPEG/audio
 * committee. For further information, please contact Davis Pan, 508-493-2241, e-mail:
 * pan@3d.enet.dec.com
 * 
 * VERSION 4.1 changes made since last update: date programmers comment 27.2.92 F.O.Witte (ITT
 * Intermetall) 8/24/93 M. Iwadare Changed for 1 pass decoding. 7/14/94 J. Koller useless 'typedef'
 * before huffcodetab removed-----------------------------------------------------------------------
...
final class huffcodetab
{
	 ...
	 * discard x.
	 */
	public static int huffman_decoder( huffcodetab h,
		int[] x,
		int[] y,
		int[] v,
		int[] w,
